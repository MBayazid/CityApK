...
Button mainBtn;
    String TAG = "RemindMe";
    com.example.musan.googlelocationlistenner.reminder_Folder.LocalData localData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localData = new com.example.musan.googlelocationlistenner.reminder_Folder.LocalData(getApplicationContext());
        ...
        reminderSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    NotificationScheduler.setReminder(com.example.musan.googlelocationlistenner.reminder_Folder.MainActivity.this, AlarmReceiver.class, localData.get_hour(), localData.get_min());
                    ll_set_time.setAlpha(1f);
                } else {
                    Log.d(TAG, "onCheckedChanged: false");
                    NotificationScheduler.cancelReminder(com.example.musan.googlelocationlistenner.reminder_Folder.MainActivity.this, AlarmReceiver.class);
                    ll_set_time.setAlpha(0.4f);
                }
        ...
        mainBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  startActivity(new Intent(com.example.musan.reminder_alarm_mb.reminder_Folder.MainActivity.this,MainActivity_Reminder.class));
            }
        });

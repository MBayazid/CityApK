...
import com.example.musan.googlelocationlistenner.DataBase_java.LoginActivity;
...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    private EditText Texhnology_Menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Texhnology_Menu=(EditText) findViewById(R.id.editText_technology);
        ...
        Texhnology_Menu.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onStart() {
        ...
        else {    startActivity(new Intent(PhoneAuthActivity.this,DataBase_MainActivity.class));
            finish();           }
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_SIGNIN_SUCCESS:
                startActivity(new Intent(this,DataBase_MainActivity.class));
